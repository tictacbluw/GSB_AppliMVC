...
if ('/var/www/html/private/GSB_AppliMVC/' != '@'.'DATA-DIR@')
{
    $root_dir = 'PhpDocumentor';
    $path = '/var/www/html/private/GSB_AppliMVC//PhpDocumentor/docbuilder/images/';

    /**
    * common file information
    */
    include_once("PhpDocumentor/phpDocumentor/common.inc.php");
    include_once("/var/www/html/private/GSB_AppliMVC//PhpDocumentor/docbuilder/includes/utilities.php" );

    // find the .ini directory by parsing phpDocumentor.ini and extracting _phpDocumentor_options[userdir]
    $ini = phpDocumentor_parse_ini_file('/var/www/html/private/GSB_AppliMVC//PhpDocumentor/phpDocumentor.ini', true);
    if (isset($ini['_phpDocumentor_options']['userdir'])) {
    	$configdir = $ini['_phpDocumentor_options']['userdir'];
    } else {
    	$configdir =  '/var/www/html/private/GSB_AppliMVC//PhpDocumentor/user';
    }
} else {
