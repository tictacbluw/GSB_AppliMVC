...
if ('/var/www/html/private/GSB_AppliMVC/' != '@'.'WEB-DIR@')
{
    /**
    ...
    */
    ...
    require_once( '/var/www/html/private/GSB_AppliMVC/' . PATH_DELIMITER . 'PhpDocumentor/docbuilder/includes/utilities.php' );
    ...
    $ini = phpDocumentor_parse_ini_file('/var/www/html/private/GSB_AppliMVC/' . PATH_DELIMITER . 'PhpDocumentor/phpDocumentor.ini', true);
    if (isset($ini['_phpDocumentor_options']['userdir'])) {
        $configdir = $ini['_phpDocumentor_options']['userdir'];
    } else {
        $configdir = '/var/www/html/private/GSB_AppliMVC/' . PATH_DELIMITER . 'PhpDocumentor/user';
    }
} else {
